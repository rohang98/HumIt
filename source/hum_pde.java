...
public class hum_pde extends PApplet {
...
public void draw()
{
    if ( (buttonActive == true) ){
      ...
      textSize(14);
      text(coinbaseButtonText, xStart+7.5f, yStart+15, xEnd, yEnd+15);
  } else {
    noFill();
  }
...
public void checkButtons() {
  ...
  public void settings() {  size(1024, 500);  smooth(); }
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "hum_pde" };
    if (passedArgs != null) {
